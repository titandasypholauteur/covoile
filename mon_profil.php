...
'        <button><a href="covoile_questcequecest.html">covoile qu\'est-ce que c\'est ?</a></button>'.
'        <button><a href="mes_trajets.html">Mes trajets</a></button>'.
'        <button><a href="ports.html">Ports</a></button>'.
...
''.
'    <main>'.
'        <p style="text-align: center;">Mes skippeurs/skippeuses</p>'.
